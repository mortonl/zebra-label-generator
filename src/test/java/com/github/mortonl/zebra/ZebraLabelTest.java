...
class ZebraLabelTest
{
    ...
    void setUp()
    {
        PrinterConfiguration printerConfiguration = PrinterConfiguration
                .builder()
                .dpi(PrintDensity.DPI_203)
                .loadedMedia(LoadedMedia.fromLabelSize(LabelSize.LABEL_4X6))
                .build();

        label = ZebraLabel.builder().printer(printerConfiguration)
                          .size(LabelSize.LABEL_4X6).build();
    }
